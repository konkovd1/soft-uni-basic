...
pen_packages = int(input()) * 5.8
markers_packages = int(input()) * 7.2
spray = int(input()) * 1.2
discount_percentage = int(input()) / 100

money_needed = pen_packages + markers_packages + spray
money_needed_with_discount = money_needed-(money_needed*discount_percentage)

print(money_needed_with_discount)
